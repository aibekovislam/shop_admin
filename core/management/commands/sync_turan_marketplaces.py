...
from core.marketplace.sync import sync_turan_marketplaces


class Command(BaseCommand):
    help = "Отправляет актуальные TURAN товары в M-Market, O!Market и Bakai Market."
    ...
    def handle(self, *args, **options):
        result = sync_turan_marketplaces(
        ...
        if result["errors"]:
            ...
            self.stdout.write(self.style.SUCCESS("TURAN marketplace sync завершен."))
