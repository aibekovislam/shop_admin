...
Цвет можно выбрать из справочника или добавить прямо при создании SKU:
заполните `Новый цвет` и выберите `HEX-код цвета`, как в старой админке Turan.
...
или категории товара, `Память` — из поля `Память`, `Цвет` — из названия
выбранного цвета.
