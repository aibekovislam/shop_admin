...
Поля O!Market с префиксом `omarket_` в M-Market не отправляются. Если поле
`Бренд товара` заполнено, оно автоматически уйдёт в обязательную
характеристику `Производители`.
